...
Create a vector called `course_topics` that contains two strings: `"data science"` and `"social science"` and print the object to the console.
...
```{r smooth-solution, exercise = TRUE}
ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
  geom_point() + geom_smooth()
```


```{r smooth-check, exercise = TRUE}
grade_this_code()
```
...
```{r log-solution, exercise = TRUE}
ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
  geom_point() + geom_smooth() + scale_x_log10()
```


```{r log-check, exercise = TRUE}
grade_this_code()
```
...
```{r log-labels-solution, exercise = TRUE}
ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
  geom_point() + geom_smooth() + scale_x_log10(labels = scales::dollar)
```


```{r log-labels-check, exercise = TRUE}
grade_this_code()
```
...
```{r color-alpha-solution, exercise = TRUE}
ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
